...
<nav class= "navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a href= "FormIniciarAdmin.cfm" class= "navbar-brand">INICIO DE SESION ADMINISTRADOR</a>
    </div>
</nav>
       ...
       <cfform name="form1" method="post" action="consUsuario.cfm">
            ...
            <div class="form-group">
                ...
                <input type="text" name="txtUsername" class="form-control" maxlength="25"
                        placeholder = "Username administrador" autofocus required>
            </div>
                <div class="form-group">
                    <input type="password" name="txtPass" class="form-control" maxlength="50"
                           placeholder="Contrasena administrador" autofocus required>
                </div>
            <hr class="mb-4">
            <div class="col-md-8 mx-auto">
                <input type="submit" class="btn btn-success btn-block" name="btnGuardar" value="Aceptar">
                <input type="hidden" class="btn btn-success btn-block" name="clave" value="1">
            </div>
  	    </cfform>
    </div>
    </div>  
