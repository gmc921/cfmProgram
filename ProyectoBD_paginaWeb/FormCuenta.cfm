...
<nav class= "navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
         <a href= "FormCuenta.cfm?nomUser=#nomUser#&dniUser=#dniUser#" class= "navbar-brand">MI CUENTA</a>
    ...
    <div class="col-md-4 mx-auto">
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  ...
                  <input type="text" name="txtUsername" class="form-control" maxlength="25" disabled value=#username#>
            </div>
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  ...
                  <input type="text" name="txtNombre" class="form-control" maxlength="25" disabled value=#nombre#>
            </div>  
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  ...
                  <input type="text" name="txtApaterno" class="form-control" maxlength="25" disabled value=#a_paterno#>
            </div> 
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  ...
                  <input type="text" name="txtAmaterno" class="form-control" maxlength="25" disabled value=#a_materno#>
            </div>  
            ...
            <div class="input-group mb-3">
               <div class="input-group-prepend">
                  ...
                  <input type="text" name="txtCorreo" class="form-control" maxlength="25" disabled value=#correo#>
            </div>
